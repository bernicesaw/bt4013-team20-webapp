...
# Fully-qualified table name in Supabase (same level as datacamp_raw)
...
def upsert_rows(rows: Iterable[Dict[str, Any]], chunk_size: int = 1000) -> int:
    ...
    Expects keys matching _COLUMNS (use your transform_for_db to shape data).
    """
